...
values (
  ...
  'Sala de Hechos',
  'Cadena de valor',
  'Expediente CGC-01 abierto. Sos parte del equipo de auditoría interna de Cadena Global de Café (CGC), la comercializadora que compra café verde a cooperativas centroamericanas y lo revende a tostadoras en Europa y EE. UU. Su directorio anunció que en 2027 será "carbono neutral, socialmente justa y 100% trazable". Un periodista obtuvo acceso parcial a los archivos antes del primer reporte y encontró inconsistencias. La Junta te pide verificar, con evidencia, si esa promesa se sostiene. Tu primera tarea: reconstruir cómo se mueve el café del cafetal a la taza. Sin esa ruta clara, cualquier cifra de sostenibilidad queda sin respaldo.',
