...
values (
  ...
  '{"precio_taza":"US$4.00 — precio de referencia de una taza en cafetería (rango del caso: US$3 a US$5)","reparto_taza":{"persona_caficultora":"US$0.15 – US$0.20","procesamiento_exportacion":"US$0.40","tostado_logistica_internacional":"US$1.10","cafeteria_venta_final":"US$2.30 – US$2.35"},"nota_mercado_c":"El pago a la persona caficultora se fija por el precio del mercado C (bolsa de materias primas), no por sus costos reales de producción.","ingresos_familias":"En 2017, los ingresos de las familias caficultoras en Perú y Etiopía fueron 20% más bajos que en 2005, ubicándose muy por debajo del umbral de pobreza.","participacion_cadena_global":"Los países productores reciben en promedio entre el 23% y el 27% del valor total generado por la cadena del café.","fuente":"Datos del expediente CGC — caso base #4.3","nota_auditora":"CGC no es villana: es una empresa cuyo discurso aún no está respaldado por evidencia. Tu rol es auditar, no juzgar."}'::jsonb,
  'Calculá qué porcentaje del precio final (US$4.00) recibe la persona caficultora y reflexioná si existe una inconsistencia al compararlo con el rango 23 – 27% de participación que reporta la cadena global en su conjunto.',
...
CGC no puede afirmar ser sostenible; puede afirmar que está en proceso de auditar y mejorar sus tres pilares. <b>Código: 4. Maestro combina 06-87-04-2P-4.</b>',
  '4',
